...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { available_seats: @table.available_seats, seats: @table.seats, shift_id: @table.shift_id }
    end
  ...
  test "should update table" do
    patch :update, id: @table, table: { available_seats: @table.available_seats, seats: @table.seats, shift_id: @table.shift_id }
    assert_redirected_to table_path(assigns(:table))
  end
